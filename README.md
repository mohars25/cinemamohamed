Un site internet inspiré d'Allociné.fr, avec un écran d'accueil affichant des films et un diaporama d'acteurs modifiable via l'ID de la base de données.
